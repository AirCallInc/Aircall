...
namespace BizObjects
{
    public class State:BizObject
    {
        ...
        public State(ref DataRow drRow)
        {
        ...
        {
            dataLib.AddParameter("@StateName", SqlDbType.NVarChar, this.Name);
            dataLib.AddParameter("@IsActive", SqlDbType.Bit, this.Status);
