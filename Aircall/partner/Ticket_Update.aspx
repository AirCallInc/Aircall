<%@ Page Title="" Language="C#" MasterPageFile="~/partner/PartnerMaster.Master" AutoEventWireup="true" CodeBehind="Ticket_Update.aspx.cs" Inherits="Aircall.partner.List_Update" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Ticket Details</a><span class="divider-last">&nbsp;</span></li>
                </ul>
            </div>
        </div>
        <div class="row-fluid">
            ...
            <div class="span12">
                <div class="widget">
                    <div class="widget-title">
                        <h4>
                            <i class="icon-magic"></i>&nbsp;Ticket Information</h4>
                                                ...
                                                <li class="<%# Eval("ClassIdentifier") %>">
                                                    ...
                                                    <div class="message ">
                                                        ...
                                                        <span class="datetime">at
                                                            <asp:Literal ID="ltrMessageDate" runat="server"></asp:Literal></span>
                                ...
                                <div class="widget-body">
                                    <div class="control-group">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="button" onclick="window.location.href = '<%=Application["SiteAddress"]%>partner/Ticket_List.aspx'" id="btncancel" class="btn">Cancel</button>
