<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="News_List.aspx.cs" Inherits="Aircall.admin.News_List" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">News List</a><span class="divider-last">&nbsp;</span></li>
                </ul>
            </div>
        </div>
        <div class="row-fluid">
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="dvbuttons">
                            ...
                            <a class="btn btn-info add" href="<%=Application["SiteAddress"]%>admin/News_AddEdit.aspx">
                                <i class="icon-plus icon-white"></i>&nbsp; Add News
                            </a>
                        </div>
                                    ...
                                    <ItemTemplate>
                                        <tr class="odd gradeX">
                                            <td>
                                                ...
                                                <asp:HiddenField ID="hdNewsId" runat="server" Value='<%#Eval("Id") %>' />
                                            </td>
                                            <td><%# Container.DataItemIndex + 1 %></td>
                                            <td><%#Eval("NewsHeading") %></td>
                                            <td><%#Convert.ToDateTime(Eval("PublishDate")).ToString("MM/dd/yyyy") %></td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<%=Application["SiteAddress"]%>admin/News_AddEdit.aspx?NewsId=<%#Eval("Id") %>" class="btn mini purple"><i class="icon-edit"></i>Edit</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:ListView>
