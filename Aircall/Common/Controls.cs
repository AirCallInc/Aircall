...
{
    public class CKEditorControl : HtmlTextArea
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            settings.Add("baseHref: '" + ResolveUrl(BasePath) + "'");
            ...
            ScriptManager.RegisterClientScriptInclude(this, this.GetType(), "ckeditorScript", VirtualPathUtility.AppendTrailingSlash(ResolveUrl(BasePath)) + "ckeditor.js");
