...
{
    public class ClientUnitManuals : BizObject
    {
        ...
        #region "Constructors"
        public ClientUnitManuals()
        {
        }
        public ClientUnitManuals(ref DataRow drRow)
        {
        ...
        public override void AddInsertParams(ref ZWT.DbLib.IDataLib dataLib)
        {
            ...
            dataLib.AddParameter("@ManualName", SqlDbType.NVarChar, this.ManualName);
