<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Aircall.partner.Login" %>
...
<body id="login-body">
    <div class="login-header">
        <div id="logo" class="center">
            <img src="<%=Application["SiteAddress"] %>partner/img/logo.png" alt="logo" class="center" style="max-width: 175px;" />
        </div>
    </div>
    <div id="login">
