<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="recurring_report.aspx.cs" Inherits="Aircall.admin.recurring_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                <h3 class="page-title">Recurring Billing Report</h3>
                <ul class="breadcrumb">
                    <li>
                        <a href="<%=Application["SiteAddress"]%>admin/dashboard.aspx"><i class="icon-home"></i></a>
                        <span class="divider">&nbsp;</span>
                    </li>
                    <li><a href="#">Recurring Billing Report</a><span class="divider-last">&nbsp;</span></li>
                </ul>
            </div>
        </div>
        <div class="row-fluid">
            <div class="span12">
                <div class="widget">
                    <div class="widget-title">
                        <h4><i class="icon-filter"></i>&nbsp;Recurring Billing Report Filter</h4>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget">
                    <div class="widget-title">
                        <h4><i class="icon-bar-chart"></i>&nbsp;Recurring Billing Report</h4>
                    </div>
                    <div class="widget-body">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget">
                    <div class="widget-title">
                        <h4><i class="icon-bar-chart"></i>&nbsp;Billing History for client</h4>
                    </div>
                    <div class="widget-body">
                                        ...
                                        <asp:ListView ID="lstRating" runat="server">
                                            <ItemTemplate>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td data-title="Client Name"><a href="#"><%# Eval("ClientName") %></a></td>
                                                    <td data-title="Charged Date"><%# DateTime.Parse(Eval("TransactionDate").ToString()).ToString("MM/dd/yyyy") %></td>
                                                    <td data-title="Address"><%# Eval("Address") %>,<br/><%# Eval("City") %>,<%# Eval("State") %>-<%# Eval("ZipCode") %></td>
                                                    <td data-title="Failed Transaction"><%# Eval("Status") %></td>
                                                    <td data-title="Transaction Id"><%# Eval("TransactionId") %></td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:ListView>
    ...
    <script>
        ...
        function BindClientData(strmonth, stryear, PartName) {
            $.ajax({
                type: "POST",
                url: "recurring_report.aspx/BindChart",
                data: "{'ClientName':'" + $("#txtManufactureName").val() + "','strmonth':'" + strmonth + "','stryear':'" + stryear + "'}",
        ...
        function BindBarChart(pageviews) {
            $('#barChart').highcharts({                
                ...
                tooltip: {
                    pointFormat: 'Order on <b>{point.name} </b> : <b>$ {point.y} </b>'
                },
                series: [{
                    name: 'Population',
                    data: pageviews,
