<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="sales_report.aspx.cs" Inherits="Aircall.admin.sales_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <asp:Button ID="Button1" class="btn btn-success" runat="server" ValidationGroup="ChangeGroup" Text="Search" OnClick="Button1_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <asp:ListView ID="lstSales" runat="server">
                            <ItemTemplate>
                                <tr class="odd gradeX" runat="server" id="trTd">
                                    ...
                                    <td>
                                        <a href="<%=Application["SiteAddress"]%>admin/SalesPerDay.aspx?SaleDay=<%#Eval("SaleDay") %>"><%#Eval("SaleDay") %></a>
                                    </td>
    ...
    <script>
        ...
        function atpageload() {
            var strmonth = $('#drpMonth').val();
            var stryear = $('#ddlYear').val();
            BindClientData(strmonth, stryear);
        }
        function BindClientData(strmonth, stryear) {
            $.ajax({
                ...
                data: "{'ClientName':'" + $("#txtClientName").val() + "','strmonth':'" + strmonth + "','stryear':'" + stryear + "','PlanType':" + "0" + "}",
                ...
                tooltip: {
                    formatter: function () {
                        ...
                        if ($('#drpMonth option:selected').val() != "0") {
                            ...
                            monthname = month[this.x + 1];
                            return 'Order on <b>' + monthname + '/' + stryear + ' = $ ' + Highcharts.numberFormat(this.y, 2) + '</b>';
                        }
