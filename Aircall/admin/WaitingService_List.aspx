<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="WaitingService_List.aspx.cs" Inherits="Aircall.admin.WaitingService_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                <h3 class="page-title">Waiting For Service Approval</h3>
                <ul class="breadcrumb">
                    <li><a href="<%=Application["SiteAddress"]%>admin/dashboard.aspx"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>

                    <li><a href="#">Waiting For Service Approval</a><span class="divider-last">&nbsp;</span></li>
                </ul>
            </div>
        </div>
        <div class="row-fluid">
                ...
                <div class="widget">
                    ...
                    <div class="widget-title">
                        <h4><i class="icon-wrench"></i>
                            Waiting For Service Approval List
                        </h4>
                        <span class="tools">
                    ...
                    <div class="widget-body">
                        <div class="form-horizontal filter" id="dvFilter" runat="server">
                            <div class="heading searchschedule">
                                ...
                                <input type="button" class="btn" value="Clear" onclick="location.href = 'WaitingService_List.aspx'" />
                            </div>
                        </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="UPDService" ClientIDMode="Static">
                            <ContentTemplate>
                                ...
                                <asp:ListView ID="lstWaitingServices" runat="server" OnSorting="lstWaitingServices_Sorting" OnItemDataBound="lstWaitingServices_ItemDataBound">
                                    <LayoutTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr class="odd gradeX <%#Eval("Status").ToString().ToLower().Replace(' ','-')%>">        
                                            ...
                                            <td><%#Eval("Status") %></td>
                                            <td>
                                                <a href="<%=Application["SiteAddress"]%>admin/WaitingService_Edit.aspx?ServiceId=<%#Eval("Id") %>" class="btn mini purple"><i class="icon-edit"></i>Edit</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <EmptyDataTemplate>
                                ...
                                <asp:DataPager ID="dataPagerWaitingService" runat="server" PagedControlID="lstWaitingServices"
    ...
    <script>
        $(document).ready(function () {
            ...
            jQuery('#sample_1--%>2_wrapper .dataTables_filter input').addClass("input-medium"); // modify table search input
        })
    </script>
</asp:Content>
